...
total_cargados = 0
total_no_cargados = 0
def cargarArquetipos(path_y_lista_arquetipos):
    path_arquetipos = path_y_lista_arquetipos[0]
    lista_arquetipos = path_y_lista_arquetipos[1]
    cargados = 0
    no_cargados = 0
...
cluster = os.listdir("cluster/./")
composition = os.listdir("composition/./")
entry_action = os.listdir("entry/action/./")
entry_admin_entry = os.listdir("entry/admin_entry/./")
entry_evaluation = os.listdir("entry/evaluation/./")
entry_instruction = os.listdir("entry/instruction/./")
entry_observation = os.listdir("entry/observation/./")
section = os.listdir("section/./")

arquetipos_folders =[
                    ["cluster/", cluster],
                    ["composition/", composition], 
                    ["entry/action/", entry_action],
                    ["entry/admin_entry/", entry_admin_entry],
                    ["entry/evaluation/", entry_evaluation], 
                    ["entry/instruction/", entry_instruction],
                    ["entry/observation/", entry_observation],
                    ["section/", section]
                    ]


for path_y_lista_arquetipos in arquetipos_folders:
    cargarArquetipos(path_y_lista_arquetipos)

print("Resumen:")
print("Total Cargados:",total_cargados)
print("Total No Cargados:",total_no_cargados)
print("Porsentaje no cargados:", total_no_cargados * 100 / (total_cargados + total_no_cargados),"%")
